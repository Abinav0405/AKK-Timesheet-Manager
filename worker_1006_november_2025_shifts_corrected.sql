...
-- Using exact entry/exit times with calculated break timings
-- Run check_shifts_table_columns.sql first to verify column names

-- Shift 1: Sat 1/11/25 - 23:00 to 8:00 next day, 1 hour break
INSERT INTO shifts (
    worker_id, work_date, entry_time, leave_time, 
    break_start, break_end, leave_type, worked_hours, sunday_hours, ot_hours
) VALUES (
    '1006', 
    '2025-11-01', 
    '23:00:00', 
...
-- Shift 21: Fri 21/11/25 - 15:00 to 8:00 next day, 2 hour breaks (17 hours total - 2 break = 15 hours)
INSERT INTO shifts (
    worker_id, work_date, entry_time, leave_time, 
    break_start, break_end, leave_type, worked_hours, sunday_hours, ot_hours
) VALUES (
...
-- Shift 23: Sun 23/11/25 - 15:00 to 8:00 next day, 2 hour breaks (17 hours total - 2 break = 15 hours, Sunday rates for 8 hours)
INSERT INTO shifts (
    worker_id, work_date, entry_time, leave_time, 
    break_start, break_end, leave_type, worked_hours, sunday_hours, ot_hours
) VALUES (
...
-- Shift 24: Mon 24/11/25 - 15:00 to 0:00 next day, 2 hour breaks (10 hours total - 2 break = 8 hours)
INSERT INTO shifts (
    worker_id, work_date, entry_time, leave_time, 
    break_start, break_end, leave_type, worked_hours, sunday_hours, ot_hours
) VALUES (
